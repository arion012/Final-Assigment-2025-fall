...
#from checking high leverage cases and cook distance we found that there is one data point which is highly influential on the model. Altough this can modify our results lets check the following results of the data to see if the requirements for regression are still fulfilled. 
...
Data_modified_alt <- Data_modified[-c(171, 129, 145), ]
...
supmodelfinal <- lm_model %>% 
  last_fit(cr ~ ac + hp_number * size, Data_modified1)
           split = Ddsplit)
